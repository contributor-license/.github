...
Applies to every repository in the `contributor-license` organization that does
...
Expect an acknowledgment within a few days. Fixes ship in a patch release and
the advisory is published with credit, unless you would rather not be named.

## What we care about most

This organization builds tooling that repositories grant write access to, and
